...
//		)
		...
		define('APP',$arr[0]);
        //1.把应用比如："entry"定义为常量CONTROLLER
        //2.在houdunwang/view/View.php文件里的View类的make方法组合模板路径，需要用的应用比如:entry的名字
        //entry是默认应用，有可能为admin后台应用，所以不能写死
		define('CONTROLLER',$arr[1]);
        //1.把应用比如："index"定义为常量ACTION
        //2.在houdunwang/view/View.php文件里的View类的make方法组合模板路径，需要用的应用比如:index的名字
        //index是默认应用，有可能为admin后台应用，所以不能写死
		define('ACTION',$arr[2]);
